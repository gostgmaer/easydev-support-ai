...
describe('Customer DDD Domain Model', () => {
  ...
  describe('Value Objects', () => {
    it('should validate email format', () => {
      ...
      expect(CustomerEmail.create('TEST@EXAMPLE.COM').value).toBe(
        'test@example.com',
      );
    });
    ...
    it('should validate phone format', () => {
      ...
      expect(CustomerPhone.create('+1-234-567-8900').value).toBe(
        '+1-234-567-8900',
      );
    });
    ...
    it('should validate timezone length', () => {
      ...
      expect(CustomerTimezone.create('America/New_York').value).toBe(
        'America/New_York',
      );
    });
    ...
    it('should validate status value', () => {
      ...
      expect(CustomerStatus.create(CustomerStatusEnum.ACTIVE).value).toBe(
  ...
  describe('Customer Aggregate Root', () => {
    ...
    it('should create a customer aggregate and append customer.created event', () => {
      ...
      expect((customer.domainEvents[0] as any).constructor.eventName).toBe(
        'customer.created',
      );
    });

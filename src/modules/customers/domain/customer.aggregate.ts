...
export class Customer extends AggregateRoot<string> {
  ...
  get phone(): CustomerPhone | undefined {
    return this.props.phone;
  }
  get status(): CustomerStatus {
    return this.props.status;
  }
  get preferredLanguage(): CustomerLanguage {
    return this.props.preferredLanguage;
  }
  get timezone(): CustomerTimezone {
  ...
  get profile(): CustomerProfile | undefined {
    return this.props.profile;
  }
  get metrics(): CustomerMetrics | undefined {
  ...
  public static create(
    id: string,
    props: Omit<CustomerProps, 'createdAt' | 'updatedAt' | 'version'>,
  ): Customer {
  ...
  public assignSegment(segmentId: string): void {
    this.addDomainEvent(
      new CustomerSegmentAssignedEvent(this.tenantId, this.id, segmentId),
    );
  }
  ...
  public updateMetrics(metrics: CustomerMetrics): void {
    ...
    this.addDomainEvent(
      new CustomerMetricsUpdatedEvent(this.tenantId, this.id, metrics.toJSON()),
    );
  }

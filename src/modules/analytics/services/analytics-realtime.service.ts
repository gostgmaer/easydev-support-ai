    ...
    OnModuleDestroy
{
  ...
  // Live Metrics methods used by controller / dashboard. Previously returned
  // Math.random() placeholders - every dashboard refresh showed different
  // numbers with no relationship to real tenant data.
